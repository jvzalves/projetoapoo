...
public class Shopping implements interfaces.ProductService {
	    ...
	    try {
	        ...
	        if (!productsListDisplayed) {
	            ...
	            while (rs.next()) {
	                ...
	                System.out.println(idProduct + ", " + nameProduct + ", R$ " + priceProduct + ", Quantidade: " + quantityProduct);
	            }
			...
			for (Product p :   products) {
				if (p != null) {
					System.out.println("Id: " + p.getId() + ", " + "Produto: " + p.getName() + ", " + "Preço: " + p.getPrice());					
				}
			}
	        ...
	        System.out.println();
	        System.out.println("Produto escolhido: " +"Id: " + idProduct + ", " + nameProduct + ", " + "Preço: " + Product.doubletoSToString(priceProduct));
	...
	public void checkOut() {
	    double totalValue = 0.0;  // Inicializa a variável que armazenará o valor total da compra
	    System.out.println("Produtos: ");

	    for (Map.Entry<Product, Integer> entry : cart.entrySet()) {    // Obtém o produto e a quantidade associada à entrada
	        Product product = entry.getKey();
	        int quantity = entry.getValue();

	        if (product != null) {
	            totalValue += product.getPrice() * quantity;  // Calcula o valor total do produto multiplicando o preço pela quantidade
	            System.out.println(product + "\nQuantidade: " + quantity);
	            System.out.println("-----------------------------------------------------------");
	        }
	    }

	    System.out.println("Valor total da sua compra: " + Product.doubletoSToString(totalValue) + "  \nMétodo de Pagamento: " + paymentMethodString); // Inclui a forma de pagamento escolhida na mensagem
	    cart.clear(); // Limpa o carrinho após o checkout ser concluído
	    products.clear();// Limpa o mapa de produtos após o checkout ser concluído
